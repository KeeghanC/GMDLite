Main.exe		: 	Main.o  transform.o AstarSearch.o LPAstar.o Dstar.o gridworld.o graphics.o 
	g++ -Wl,-s -o Main.exe Main.o transform.o AstarSearch.o LPAstar.o Dstar.o gridworld.o graphics.o -l gdi32 
...
Dstar.o		:	 Dstar.cpp Dstar.h
	g++ -c -std=c++11 -O2  -fpermissive -fconserve-space -Wno-write-strings  Dstar.cpp
